            ...
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                ...
                <input
                  id="input"
                  type="number"
                  className="py-2 px-4 border border-transparent appearance-none w-full border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                  required
                />
              </div>
            ) : null}
