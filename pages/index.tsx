...
const Home: NextPage = () => {
  return (
    <div className="bg-slate-400 dark py-20 px-20 xl:place-content-center grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
      <div className="bg-white dark:bg-black flex flex-col justify-between p-6 rounded-3xl shadow-xl">
        ...
        <div className="flex items-center">
          <button
            className="mt-5 bg-blue-500 text-white p-3 dark:bg-black dark:border-whte dark:border
      ...
      <div className="bg-white overflow-hidden rounded-3xl shadow-xl group">
        <div className="bg-blue-500 portrait:bg-indigo-400 landscape:bg-teal-500 p-6 pb-14 xl:pb-40">
